            ...
            public void onClick(View v) {
                if (fabbutton.getTag().equals(getResources().getString(R.string.tag_send))) {
                    if (!phoneed.getText().toString().trim().isEmpty() && phoneed.getText().toString().trim().length() >= 10) {
                        ...
                        fabbutton.setImageResource(R.drawable.ic_arrow_forward_black_24dp);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            firebaseRealtimeDB.createUser(mAuth.getUid(), "None", "None", phoneed.getText().toString()+"", "", "", "Mobile Signup");
